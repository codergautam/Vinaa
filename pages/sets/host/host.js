        ...
        {data ?(
          <>
            ...
            <Card>
              ...
              <br/>
              <QRCode value={`https://vinaa.net/sets/${setId}?liveMode=${code.current}`} size={500} />
              <h1>URL: <a href={`https://vinaa.net/api/joinredirect?code=${code.current}`}>{`https://vinaa.net/api/joinredirect?code=${code.current}`}</a></h1>
              <Button onClick={() => {
